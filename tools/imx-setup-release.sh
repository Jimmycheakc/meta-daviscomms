...
. sources/meta-daviscomms/tools/setup-utils.sh
...
FSL_EULA_FILE=$CWD/sources/meta-daviscomms/EULA.txt
...
META_FSL_BSP_RELEASE="${CWD}/sources/meta-daviscomms/meta-bsp"
